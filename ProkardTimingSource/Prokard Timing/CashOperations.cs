     ...
     //       ci.selectComboBoxValueById(userSelectedMode_comboBox1, idDefaultRaceMode);
       ...
       //     }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                admin.model.Jurnal_Cassa("1", Convert.ToInt32(PilotID), Race.RaceID, priceForCurrentRace_textBox5.Text, "0", "Оплата участия в рейсе." + SaleComment, false);
            }
            else
            {
                admin.model.Jurnal_UserCashByUserId("6", Convert.ToInt32(PilotID),
                    ...
                    + " Cъём со счета пользователя.", Race.RaceID);
                InUserCash = true;
            }

            if (moveRestToUserAccount_checkBox1.Checked && moveRestToUserAccount_checkBox1.Enabled)
            {
                admin.model.Jurnal_AddToUserCash("3", Convert.ToInt32(PilotID), textBox4.Text, "0", "Коррекция баланса пользователя.");
            }
